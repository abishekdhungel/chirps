...
define('modules/home',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth) {
  'use strict';
  ...
  var Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService), _dec(_class = function () {
...
define('modules/wall',['exports', 'aurelia-framework', 'aurelia-router', 'aurelia-auth', '../resources/data/chirps'], function (exports, _aureliaFramework, _aureliaRouter, _aureliaAuth, _chirps) {
  'use strict';
  ...
  var Wall = exports.Wall = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaAuth.AuthService, _chirps.Chirps), _dec(_class = function () {
    function Wall(router, auth, chirps) {
...
define('resources/data/users',["exports"], function (exports) {
    "use strict";
